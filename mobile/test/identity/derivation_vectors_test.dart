...
const List<Vector> vectors = <Vector>[
  Vector(
    ...
    domain: 'twitter.com',
    accountIndex: 0,
    email: 'gct2cynip2o5@mail.shadow.test',
  ...
  Vector(
    ...
    domain: 'twitter.com',
    accountIndex: 1,
    email: 'esw3byzhzz7n@mail.shadow.test',
  ...
  Vector(
    ...
    accountIndex: 0,
    email: '55o5h2lfdibh@mail.shadow.test',
  ...
  Vector(
    ...
    domain: 'twitter.com',
    accountIndex: 0,
    email: 'pcyf646lnxzo@mail.shadow.test',
  ...
  Vector(
    ...
    domain: 'example.co.uk',
    accountIndex: 1,
    email: 'zqqcoa7kocga@mail.shadow.test',
