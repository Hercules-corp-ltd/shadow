...
class HandleShaper {
  ...
  static const List<String> _adjectives = <String>[
    'amber', 'ancient', 'arctic', 'autumn', 'blue', 'bold', 'brave', 'bright',
    'calm', 'clever', 'cobalt', 'cosmic', 'crimson', 'crystal', 'daily',
    'dawn', 'deep', 'dusty', 'eager', 'early', 'east', 'electric', 'ember',
    'fair', 'fast', 'fern', 'first', 'flint', 'free', 'frost', 'gentle',
    'gilded', 'glass', 'golden', 'grand', 'green', 'grey', 'happy', 'hidden',
    'high', 'hollow', 'humble', 'ivory', 'jade', 'keen', 'kind', 'late',
    'lively', 'lone', 'lucky', 'lunar', 'marble', 'mellow', 'mighty', 'misty',
    'modern', 'north', 'olive', 'open', 'pale', 'patient', 'plain', 'polar',
    'proud', 'quick', 'quiet', 'rapid', 'raven', 'ready', 'red', 'river',
    'rough', 'royal', 'rustic', 'sable', 'sage', 'salt', 'sharp', 'silent',
    'silver', 'simple', 'slate', 'small', 'smooth', 'snowy', 'solar', 'solid',
    'south', 'spare', 'spring', 'steady', 'steel', 'still', 'stone', 'storm',
    'summer', 'sunny', 'swift', 'tall', 'teal', 'tidy', 'true', 'urban',
    'velvet', 'violet', 'warm', 'west', 'wild', 'winter', 'wise', 'young',
  ];

  static const List<String> _nouns = <String>[
    'acorn', 'anchor', 'arbor', 'arrow', 'aspen', 'atlas', 'basin', 'beacon',
    'birch', 'bison', 'bloom', 'bluff', 'branch', 'bridge', 'brook', 'canyon',
    'cedar', 'cliff', 'clover', 'comet', 'compass', 'coral', 'cove', 'crane',
    'creek', 'crest', 'delta', 'dune', 'eagle', 'ember', 'falcon', 'fathom',
    'fern', 'field', 'finch', 'fjord', 'forest', 'forge', 'fox', 'garden',
    'glade', 'glacier', 'granite', 'grove', 'harbor', 'harvest', 'haven',
    'hawk', 'heron', 'hollow', 'horizon', 'island', 'juniper', 'lantern',
    'ledge', 'lily', 'linden', 'lodge', 'maple', 'meadow', 'mesa', 'meteor',
    'moss', 'mountain', 'oak', 'oasis', 'orchard', 'osprey', 'otter', 'palm',
    'peak', 'pebble', 'pine', 'plateau', 'pond', 'prairie', 'quarry', 'quill',
    'rapids', 'reef', 'ridge', 'river', 'sable', 'sage', 'sail', 'sequoia',
    'shore', 'signal', 'sparrow', 'spruce', 'stone', 'stream', 'summit',
    'thicket', 'thorn', 'tide', 'timber', 'trail', 'tundra', 'valley', 'vale',
